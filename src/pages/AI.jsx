  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gray-800 rounded-full p-2 sm:p-4 flex justify-center items-center gap-2 sm:gap-4 md:gap-6 lg:gap-8 overflow-x-auto">
            ...
            <span className="text-cyan-400 font-medium text-xs sm:text-sm border-b-2 border-cyan-400 pb-1 whitespace-nowrap">AI</span>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-32 text-center">
        <h1 className="text-4xl sm:text-6xl font-bold text-white mb-6 sm:mb-8">AI</h1>
        <div className="bg-gray-800 rounded-lg p-6 sm:p-12">
          ...
          <p className="text-gray-300 text-base sm:text-xl leading-relaxed mb-6 sm:mb-8">
            Explore my AI-powered projects, machine learning experiments, and insights 
            into artificial intelligence. I'm building something amazing that will 
            showcase the future of AI integration in web applications.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 lg:gap-0">
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 lg:gap-8">
              ...
              <span className="text-cyan-400 font-medium text-xs sm:text-sm border-b-2 border-cyan-400 pb-1">AI</span>
